#!/usr/bin/env python3
"""Defines a DeepNeuralNetwork class with configurable activation."""
import pickle
...
class DeepNeuralNetwork:
    """Deep neural network supporting sigmoid and tanh hidden activations."""

    def __init__(self, nx, layers, activation='sig'):
        """Initialize deep neural network with configurable activation.
    ...
    def forward_prop(self, X):
        """Calculate forward propagation using configured hidden activation.
    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        """Perform one pass of gradient descent using configured activation.
